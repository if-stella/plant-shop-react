...
const Headlinecards = () => {
  return (
    <div className='max-w-[1640px] mx-auto px-6 py-6 md:py-16 grid md:grid-cols-3 gap-6 bg-gradient-to-t from-[#D6E5E5]'>
      <div className='rounded relative h-[120px] md:h-[170px] lg:h-[160px] bg-[#F4F7F7] shadow-xl'>

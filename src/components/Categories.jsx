...
const Categories = () => {
  ...
  return (
    <div className='max-w-[1640px] m-auto px-6 py-12 bg-gradient-to-b from-[#D6E5E5] to-[#0e1717]'>
      <h3 className='text-4xl text-center text-[#558A76] serife'>Get inspired...</h3>
